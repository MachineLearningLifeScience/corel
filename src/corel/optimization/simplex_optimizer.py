...
def make_simplex_optimizer(dataset=None, batch_evaluations=1):
    ...
    def _make_optimizer(search_space, acquisition_function, x0=None):
        # TODO: Choose each observed sequence as starting candidate.
        # TODO: Don't forget to remove padding symbols!
        # TODO: Set L according to the length of each candidate without padding symbol.
        #L = search_space.dimension.numpy()
        L = None
        raise NotImplementedError("The code above needs some adaption for the unaligned setting!")
